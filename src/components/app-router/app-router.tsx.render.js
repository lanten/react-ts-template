module.exports = ({ USE_REDUX }) => {
  return [
    `import React from 'react'`,
    `import { BrowserRouter as Router, Route, Switch, Redirect, RouteComponentProps } from 'react-router-dom'`,
    USE_REDUX && `import { withStore } from '@/store'`,
    `import { asyncImport as AsyncImport } from '../async-import'`,
    ``,
    `interface AppRouterProps${USE_REDUX ? ' extends DefaultProps' : ''} {`,
    ...
    `}`,
    ``,
    USE_REDUX && `@withStore(['userPermissions'])`,
    ...
    ...(USE_REDUX
      ? [`    const nextProps = Object.assign({}, props)`, `    const { userPermissions } = this.props`, ``]
      : []),
